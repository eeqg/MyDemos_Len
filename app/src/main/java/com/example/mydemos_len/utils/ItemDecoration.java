...
/**
 * sticky-headers
 * https://github.com/timehop/sticky-headers-recyclerview/blob/70980fb33c0b6b04a7248029916a06194975fc39/sample/src/main/java/com/timehop/stickyheadersrecyclerview/sample/DividerDecoration.java
 */
...
public class ItemDecoration extends RecyclerView.ItemDecoration {
  ...
  private int getOrientation(RecyclerView parent) {
    ...
    try {
      ...
      throw new IllegalStateException("ItemDecoration can only be used with a " +
